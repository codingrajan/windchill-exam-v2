  ...
  return (
    <Router>
      <div className="min-h-screen bg-[#0F172A] text-[#F8FAFC] flex flex-col items-center font-sans">
        ...
        <header className="w-full bg-[#1E293B]/80 backdrop-blur-xl border-b border-[#334155] p-4 sticky top-0 z-50">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <img src="/images/plural_logo.jpg" alt="Plural" className="h-10 rounded shadow-sm" />
            </div>
